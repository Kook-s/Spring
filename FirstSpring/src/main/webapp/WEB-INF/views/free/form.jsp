	...
	<div class="container">
		<form id="form" action="" class="form-horizontal" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input id="title" name="boTitle" type="text" class="form-control" value="${free.boTitle }" placeholder="subject">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 control-label" >내용</label>
				<div class="col-sm-8">
					<textarea id="content" name="boContent" cols="50" rows="5" class="form-control" placeholder="content">${free.boContent }</textarea>
				</div>
			</div>
			<div class="form-group row">
...
$(()=>{
	...
	btn.on("click",function(){
		...
		if(val=='수정'){
			...
			$("#form").append("<input type='text' name='boNo' value='${free.boNo}'>")
			$("#form").submit()
		}
		if(val=='취소'){
			if('${status}'=='u'){
		...
		if(val=='등록'){
			...
			$("#form").attr("action","/free/insert.do")
			$("#form").submit()
		}
	})
